...
class Ball:
    ...
    def move(self):
        ...
        if self.x < 0 or self.x > self.screen.get_width():
            self.bouncex()
            balllist.append(Ball(self.color, 10, random.randint(0, 640), 240, self.screen, -self.xspeed, -self.yspeed))
...
ball = Ball((0, 255, 0), 20, 300, 200, screen, 1, 1)
ball2 = Ball((0, 0, 255), 30, 100, 300, screen, -1.2, 1.5)
