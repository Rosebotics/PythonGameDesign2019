...
class Missile:
    ...
    def draw(self):
        pygame.draw.line(self.screen,(255, 175, 45), (self.x, self.y), (self.x, self.y + 8), 1)
        pass
...
class EnemyMissile:
    ...
    def draw(self):
        pygame.draw.line(self.screen,(255, 15, 255), (self.x, self.y), (self.x, self.y + 8), 1)
        pass
...
class Badguy:
    ...
    def hit_by(self, missile):
        ...
        for badguy in enemy.badguys:
            for enemymissile in badguy.missile:
...
def main():
    ...
    pygame.display.set_caption("O:<Space Invasion >:D")
    ...
    #   TODO: Make a   while True:    loop.
        ...
        # TODO 11: See your Pong game for how you drew the Ball
        fighter.draw()
